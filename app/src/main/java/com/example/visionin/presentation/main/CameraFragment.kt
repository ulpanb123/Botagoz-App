...
import com.example.visionin.presentation.utils.AutoFitSurfaceView
import com.example.visionin.presentation.utils.OrientationLiveData
import com.example.visionin.presentation.utils.computeExifOrientation
import com.example.visionin.presentation.utils.getPreviewOutputSize
...
class CameraFragment : Fragment() {
    ...
    private val characteristics: CameraCharacteristics by lazy {
        cameraManager.getCameraCharacteristics(getCameraId(requireContext(), CameraCharacteristics.LENS_FACING_BACK))
    }
...
//        }
    ...
    private fun initializeCamera() = lifecycleScope.launch(Dispatchers.Main) {
        ...
        camera = openCamera(cameraManager, getCameraId(requireContext(), CameraCharacteristics.LENS_FACING_BACK), cameraHandler)
    ...
    fun handleCaptureClick(view : View?) {
...
//                     Display the photo taken to user
                    val byteArray = loadInputBuffer(output.absolutePath)
                    decodeBitmap(byteArray, 0, byteArray.size)
    ...
    private fun decodeBitmap(buffer: ByteArray, start: Int, length: Int) {
        ...
        val parentFrag = this.parentFragment as MainFragment
        parentFrag.passBitmap(rotatedBitmap)
    }
